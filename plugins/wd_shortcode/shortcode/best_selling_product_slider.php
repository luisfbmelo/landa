					...
					<div class="row">
						...
						<div class="product-slider-body <?php if($box_style == 'style-boxed') echo "col-sm-24";?>">
							...
							<div class="product-slider-wrapper <?php echo $extra_class;?>">	
								...
								<div class="product-slider-inner <?php if($box_style !== 'style-boxed') echo "row";?> <?php echo esc_attr($show_nav_pos);?> wd-loading">
...
add_shortcode('wd_best_selling_product_slider','wd_best_selling_product_slider_function');	
?>