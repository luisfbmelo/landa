...
<div class="wd_edit_account">
	<h2 class="wd_edit_title"><?php _e('edit account','wpdance') ?></h2>
	...
	<form action="" method="post">
		...
		<fieldset>
			<legend><?php _e( 'Password Change', 'wpdance' ); ?></legend>
			<p class="form-row form-row-wide">
		...
		<p>
			...
			<input type="submit" class="button" name="save_account_details" value="<?php _e( 'Save changes', 'wpdance' ); ?>" />
