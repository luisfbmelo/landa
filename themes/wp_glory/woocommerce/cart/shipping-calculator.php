...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	<div class="shipping-calculator-wrapper">
		<h3 class="heading-title"><?php _e( 'shipping & tax', 'wpdance' ); ?></h3>
		<div class="line line-30"></div>
		<div class="shipping-calculator-form">
			<p class="form-row form-row-wide">
				<label for="calc_shipping_country">
					<?php _e( 'Select a country', 'wpdance' ); ?> <abbr class="required" title="required">*</abbr>
				</label>
			...
			<p class="form-row form-row-wide">
				<label for="calc_shipping_country">
					<?php _e( 'State / county', 'wpdance' ); ?> <abbr class="required" title="required">*</abbr>
				</label>
				<?php
			...
			<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
				<p class="form-row form-row-wide">
					<label for="calc_shipping_country">
						<?php _e( 'Postcode / Zip', 'wpdance' ); ?> <abbr class="required" title="required">*</abbr>
					</label>
			...
			<p class="wd_shipping_bt"><button type="submit" name="calc_shipping" value="1" class="button"><?php _e( 'Update Total', 'wpdance' ); ?></button></p>	
