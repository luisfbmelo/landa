...
<form action="<?php echo esc_url(  WC()->cart->get_cart_url() ); ?>" class="wd_form_cart overflow-x" method="post">
...
<div class="wd_cart_buttons">
	...
	<a class="button backtoshop" href="<?php echo get_permalink(woocommerce_get_page_id('shop')); ?>"><?php _e( 'Back To Shop', 'wpdance' ) ?></a>
</div>
		...
		<div class="coupon_wrapper">
				...
				<?php if ( WC()->cart->coupons_enabled() ) { ?>
					<div class="coupon">
						...
						<h3 class="heading-title"><?php _e( 'Discount code', 'wpdance' ); ?></h3>
						<div class="line line-30"></div>
						<input name="coupon_code" placeholder="<?php esc_attr_e('Enter your coupon code if your have one', 'wpdance');?>" class="input-text" id="coupon_code" value="" /> 
