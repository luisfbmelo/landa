		...
		if( (int)$post_id > 0 ){
			...
			if( is_array($slider_datas) && count($slider_datas) > 0 ){
				...
				<div class="featured_product_slider_wrapper shortcode_slider" id="<?php echo $_random_id;?>">
					<div class="fredsel_slider_wrapper_inner height_auto">
						<ul>
							<?php
								foreach( $slider_datas as $_slider ){
							?>	
								<li>
									<a href="<?php echo esc_url($_slider['url']);?>" title="<?php echo esc_attr($_slider['slide_title']);?>">
						...
						<div class="slider_control">
							<a id="<?php echo esc_attr($_random_id);?>_prev" class="prev" href="#">&lt;</a>
							<a id="<?php echo esc_attr($_random_id);?>_next" class="next" href="#">&gt;</a>
						</div>
					</div>
				</div>
				<script type='text/javascript'>
				//<![CDATA[
					jQuery(document).ready(function() {
						...
						jQuery("#<?php echo esc_js($_random_id);?> > .fredsel_slider_wrapper_inner > ul").carouFredSel({
							items 				: {
								width: <?php echo esc_js($_width);?>
							...
							,prev				: '#<?php echo esc_js($_random_id);?>_prev'
							,next				: '#<?php echo esc_js($_random_id);?>_next'
							,pagination 		: '#<?php echo esc_js($_random_id);?>_pager'
						});	
					});
					//]]>
				</script>
