...
function custom_nav_update($menu_id, $menu_item_db_id, $args ) {
	...
	if ( isset($_REQUEST['menu-item-more-hiden']) && is_array($_REQUEST['menu-item-more-hiden']) ) {
        $custom_value = $_REQUEST['menu-item-more-hiden'][$menu_item_db_id];
        update_post_meta( $menu_item_db_id, WD_MEGA_MENU.'_menu_item_more_hiden', $custom_value );
    }
	
	if ( isset($_REQUEST['menu-item-icon']) && is_array($_REQUEST['menu-item-icon']) ) {
        $custom_value = $_REQUEST['menu-item-icon'][$menu_item_db_id];
        update_post_meta( $menu_item_db_id, WD_MEGA_MENU.'_menu_item_icon', $custom_value );
    }
	...
	if ( isset($_REQUEST['menu-item-icon-id']) && is_array($_REQUEST['menu-item-icon-id']) ) {
        ...
        update_post_meta( $menu_item_db_id, WD_MEGA_MENU.'_menu_item_icon_id', $custom_value );
    }
    ...
    if ( isset($_REQUEST['menu-item-sidebars']) && is_array($_POST['menu-item-sidebars']) ) {
...
function custom_nav_item($menu_item) {
	...
	$menu_item->more_hiden = get_post_meta( $menu_item->ID, WD_MEGA_MENU.'_menu_item_more_hiden', true );
	$menu_item->icon 		= get_post_meta( $menu_item->ID, WD_MEGA_MENU.'_menu_item_icon', true );
	$menu_item->icon_id 	= get_post_meta( $menu_item->ID, WD_MEGA_MENU.'_menu_item_icon_id', true );
