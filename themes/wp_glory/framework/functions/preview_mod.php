...
function wd_preview_panel(){
                    ...
                    <div id="custom_color_layout" class="accordion-body collapse in">
                        <div class="accordion-inner">
							...
							<ul class='wd-custom-color'>
								<li><a href="http://demo2.wpdance.com/glory_h1/" title="GLAMOR H1"><img id="custom_h1" class="wd-custom-color-image" src="<?php echo esc_url($_base_path);?>1.png" alt="custom_color h1"></a></li>
								<li><a href="http://demo2.wpdance.com/glory_h2/" title="GLAMOR H2"><img id="custom_h2" class="wd-custom-color-image" src="<?php echo esc_url($_base_path);?>2.png" alt="custom_color h2"></a></li>
								<li><a href="http://demo2.wpdance.com/glory_h3/" title="GLAMOR H3"><img id="custom_h3" class="wd-custom-color-image" src="<?php echo esc_url($_base_path);?>3.png" alt="custom_color h3"></a></li>
								<li><a href="http://demo2.wpdance.com/glory_lassy/" title="GLORY LASSY"><img id="custom_lassy" class="wd-custom-color-image" src="<?php echo esc_url($_base_path);?>4.png" alt="custom_color lassy"></a></li>
								<li><a href="http://demo2.wpdance.com/glory_decor" title="GLORY DECOR"><img id="custom_decor" class="wd-custom-color-image" src="<?php echo esc_url($_base_path);?>5.png" alt="custom_color decor"></a></li>
								<li><a href="http://demo2.wpdance.com/glory_glamor" title="GLORY GLAMOR"><img id="custom_glamor" class="wd-custom-color-image" src="<?php echo esc_url($_base_path);?>6.png" alt="custom_color glamor"></a></li>
							</ul>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery('#font-clear-btn').on('click', function(event){
			...
			set_color('.colorpicker_background_color',"#ffffff");
            jQuery('body').trigger('update_custom_preview');
        });
