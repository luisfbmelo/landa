		...
		<?php endif; ?>
			...
			<div class="comment-meta commentmetadata">
				...
				<?php
					...
					printf( __( '%1$s', 'wpdance' ), get_comment_date() ); ?>
				</a>
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/bbpress.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '2.5.7', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/contact-form-7.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/features-by-woothemes.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/LayerSlider.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/projects-by-woothemes.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/regenerate-thumbnails.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/testimonials-by-woothemes.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/wd_grid-list-toggle.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/wd_quickshop.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/wd_product-color.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			'name'     				=> 'WD Side', // The plugin name
			'slug'     				=> 'wd_slide', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/wd_slide.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '1.0.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/woocommerce.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/woosidebars.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/wp-pagenavi.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			'name'     				=> 'WD Countdown', // The plugin name
			'slug'     				=> 'wd_countdown', // The plugin slug (typically the folder name)
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/wd_countdown.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '1.0.0', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/yith-woocommerce-compare.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/framework/includes/plugins/yith-woocommerce-wishlist.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
