	...
	function end_el( &$output, $item, $depth = 0, $args = array() ) {
		...
		**/
		...
		if( $item->menu_order == $item->item_count){
			if( $this->more_menu ) {
				$output .= $indent . '<li class="menu-item wd-more-menu"><a href="javascript:void(0);"><span class="menu-label-level-0">' . __( 'More ', 'wpdance' ) . $wd_data['wd_vertical_menu_heading'] . '</span></a></li>';
			}
		}
