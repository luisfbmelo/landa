...
if($show_animate){
	$el_class .= ' not-animated';
}

if($content_middle) $el_class .= ' content-middle';

$data_extension = '';
if($show_animate){
	$data_extension .= ' data-animate="'.$animate_type.'" data-delay="'.$animate_time.'"';
}
...
$output .= "\n\t".'<div class="'.$css_class.'"'.$style.$data_extension.'>';
