											...
											<div class="wd_ads_sidebar">
												...
												<div>
													<div class="wd_ads_title form-field">
														<div class="label"><label><?php _e( 'Title', 'wpdance' ); ?>:</label></div>
													...
													<div class="wd_ads_cont form-field" >
														<div class="label"><label><?php _e( 'Content', 'wpdance' ); ?>:</label></div>
													...
													<div class="wd_ads_pos form-field">
														<div class="label"><label><?php _e( 'Position', 'wpdance' ); ?>:</label></div>
