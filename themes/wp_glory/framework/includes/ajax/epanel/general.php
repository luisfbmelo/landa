							...
							<ul style="">
								...
								<li>	
									...
									<div style="padding-left: 100px;width: 434px;">
										<input name="wd_custom_logo" type="hidden" class="custom_upload_image" value="<?php echo esc_attr($value_logo_src); ?>" />
										<img style="padding-bottom:5px;" src="<?php echo esc_url($logo_src); ?>" class="custom_preview_image" /><br />
								...
								<li class="last">
									...
									<div style="padding-left: 100px;width: 434px;">
										<input name="wd_custom_iconlogo" type="hidden" class="custom_upload_image" value="<?php echo esc_attr($value_icon_src); ?>" />
										<img style="padding-bottom:5px;" src="<?php echo esc_url($icon_src); ?>" class="custom_preview_image" /><br />
										<input class="custom_upload_image_button button" type="button" value="Choose Image" />
										<small>&nbsp;<a href="#" class="custom_clear_image_button">Remove Image</a></small>
										<br clear="all" />
