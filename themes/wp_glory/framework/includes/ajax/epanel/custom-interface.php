...
//<![CDATA[
	...
	**/
	...
	jQuery(document).ready(function() {
		...
		jQuery.ajax("<?php echo esc_js($google_font_url); ?>", {
				data : { sort: "<?php echo esc_js($font_sort);?>" }
				,dataType: 'jsonp'
											...
											<select class="font-sort" name="font_sort" id="font_sort">
												<?php if(!empty($font_sort_attr)):?>
													<?php foreach($font_sort_attr as $cs):?>
														<option value="<?php echo esc_attr($cs); ?>" <?php if(trim($cs) == trim( $font_sort )):?>selected<?php endif;?>><?php echo esc_html($cs); ?></option>
													<?php endforeach;?>
												<?php endif;?>
											</select>
										</div><!-- .bg-input-inner -->
