	...
	class WP_Widget_Twitterupdate extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			if($instance['username']){
				echo "<div class=\"follow-us-heading\"><a href=\"http://twitter.com/{$instance['username']}\" target=\"_blank\">";
				_e("Follow Us","wpdance");
				echo "</a></div>";
								...
								<ul id="twitter-list">
									...
									<li class="status-item <?php echo $class;?>">
										...
										<div class="tw_content">
											<div><a href="<?php esc_url('http://twitter.com/'.$instance['username']);?>" target="_blank"><span class="tw-name"><?php echo esc_attr($status->user->name);?></span></a></div>
